...
int main(void) {
    ...
    // Sistema de Inimigos (3 inimigos iniciais)
    Inimigo inimigos[3] = {
        {100, 50, 1, 1, 1},
        {380, 80, -1, 1, 1},
        {240, 220, 1, -1, 1}
